...
[<img src="https://github-ads.s3.eu-central-1.amazonaws.com/laravel-waitlist.jpg?t=1" width="419px" />](https://spatie.be/github-ad-click/laravel-waitlist)
...
```php
$laravelWaitlist = new Kyle Rusby\LaravelWaitlist();
echo $laravelWaitlist->echoPhrase('Hello, Kyle Rusby!');
```
